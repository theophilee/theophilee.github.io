...
- **It's all about execution.**
    Brett Adcock: "What I have learned is that the only real competitive advantage in technology is the number of product iterations and the progress made between those iterations. Essentially, I value the rate of progress in the highest regard. What matters is my team’s ability to execute at the fastest possible rate and to continue innovating over time."
